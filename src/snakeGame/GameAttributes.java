...
public abstract class GameAttributes extends Application implements Runnable {
	 ...
	 */
	public abstract Collection<BodyPart> gameStep(); // before Node
}
